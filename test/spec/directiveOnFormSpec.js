...
describe('ng-ckeditor', function () {
    ...
    it('should create editor', inject(function () {
        var flag;
        runs(function () {
    ...
    it('should change model value editor', inject(function ($timeout, $rootScope) {
        var flag;
        runs(function () {
            flag = false;
    ...
    it('should async change model value editor', inject(function ($timeout) {
        var flag;
        runs(function () {
            flag = false;
            scope.test = 'new value';
            ...
            setTimeout(function () {
                ...
                // emulate key press
                angular.element(content[0]).simulate('click')
    ...
    it('should change in source view', inject(function ($timeout) {
        var flag;
        runs(function () {
            flag = false;

            setTimeout(function () {
                angular.element('.cke_button__source').simulate('click');
                // emulate key press
                angular.element('.cke_source').simulate('click')
                    .simulate('keydown', {keyCode: 13, charCode: 0})
                    .simulate('keypress', {keyCode: 13, charCode: 0})
                    .simulate('keyup', {keyCode: 13, charCode: 0});
                $timeout.flush();
